...
public class Hand
{
	...
	public Hand(handDetermination.Card[] cards)
	{
		Cards = cards;
		Rank = determineRank(cards);
	}
	...
	static boolean isFiveOfAKind(handDetermination.Card[] Hand)
	{
	...
	static boolean isStraightFlush(handDetermination.Card[] Hand)
	{
		return isStraight(Hand) && isFlush(Hand);
	}
	
	//Determines if a hand is four of a kind
	static boolean isFourOfAKind(handDetermination.Card[] Hand)
	{
		for(int c = 0; c < Hand.length; c++)
		{
			for(int i = c + 1; i < Hand.length; i++)
	...
	static boolean isFullHouse(handDetermination.Card[] Hand)
	{
		int setThree[] = {-1, -1, -1};
		//int pairTwo[] = {-1, -1};
	...
	static boolean isFlush(handDetermination.Card[] Hand)
	{
	...
	static boolean isStraight(handDetermination.Card[] Hand)
	{
	...
	static boolean isThreeOfAKind(handDetermination.Card[] Hand)
	{
		//boolean threeFound = false;
	...
	static boolean isTwoPair(handDetermination.Card[] Hand)
	{
		int pairOne[] = {-1, -1};
	...
	static boolean isOnePair(handDetermination.Card[] Hand)
	{
	...
	static byte determineRank(handDetermination.Card[] Hand)
	{
